...
- **Fan Connector**: Allows you to connect a cooling fan to manage thermal performance for the CM4 _(It is the same connector as the [Pi 5](https://www.raspberrypi.com/documentation/computers/raspberry-pi.html#raspberry-pi-5-fan-connector-pinout) and controllable by GPIO18)._
